...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ADDRESS = "10.40.235.186";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        botonNombre = findViewById(R.id.button);
        editText2 = findViewById(R.id.lblNombre);
    ...
    class MyATaskCliente extends AsyncTask<String,Void,String>{
        ...
        protected String doInBackground(String... values){
            ...
            try {
                ...
                output.println("Desde Android: "+request);
